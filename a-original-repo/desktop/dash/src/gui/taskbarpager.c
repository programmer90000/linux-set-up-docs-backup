...
GtkWidget *taskbar_pager_get_taskbar (GtkWidget *shell, window_t *win, gboolean create) {
...
static void taskbar_pager_decorate (GtkWidget *parent, GParamSpec *spec, GtkWidget *self) {
    TaskbarPagerPrivate *priv;
    gboolean labels;
    gint title_width;
...
static void taskbar_pager_update (GtkWidget *self) {
    ...
    if (priv->button && g_strcmp0(gtk_button_get_label(GTK_BUTTON(priv->button)), title)) {
...
static gint taskbar_pager_compare (GtkWidget *a, GtkWidget *b, GtkWidget *parent) {
...
static gboolean taskbar_pager_action_exec (GtkWidget *self, gint slot, GdkEvent *ev) {
    TaskbarPagerPrivate *priv;
...
static void taskbar_pager_dnd_dest (GtkWidget *dest, GtkWidget *src, gint x, gint y) {
    workspace_t *ws;
    window_t *win;
